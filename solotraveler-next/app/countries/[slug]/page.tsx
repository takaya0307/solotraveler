      ...
      <main style={{
        ...
        <div className="info-cards-grid" style={{
          ...
          <div className="info-card" style={{
            ...
            <div style={{ margin: 0 }}>
              <p style={{ margin: '0 0 0.3rem 0', fontSize: '1.8rem', fontWeight: 800 }}>最大3年間</p>
          ...
          <section style={{ marginBottom: '5rem' }}>
            ...
            <div style={{ fontSize: '1.1rem', lineHeight: 1.8 }}>
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                オーストラリアは、南半球に位置する広大な大陸国家。一年中温暖な気候で、美しいビーチや壮大な自然が魅力の国です。シドニー・ハーバーブリッジやオペラハウスなど、世界的に有名な観光スポットも多数あります。
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>ビーチライフ</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>美しいビーチでサーフィンや日光浴</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>メルボルンのカフェでコーヒーを楽しむ</p>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>アウトドア</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>自然の中でハイキングやキャンプ</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#78350f', lineHeight: 1.6 }}>
                    一年中温暖で過ごしやすい気候。シドニーやメルボルンは四季があり、ケアンズは熱帯気候で常夏です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#1e3a8a', lineHeight: 1.6 }}>
                    比較的安全で、日本人にとって安心して生活できる環境です。ただし、都市部では一般的な防犯意識は必要です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#14532d', lineHeight: 1.6 }}>
                    オーストラリア人はフレンドリーで親しみやすい性格の人が多いです。カジュアルな文化で、すぐに友達を作りやすい環境です。
                  </p>
                </div>
              </div>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>英語学習環境：</strong>英語圏で、英語学習に最適な環境です
                </li>
                <li style={{ marginBottom: '1rem' }}>
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>長期滞在：</strong>最大3年間の滞在が可能で、じっくりと海外生活を楽しめる
                </li>
              </ul>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>聞き取りやすい英語：</strong>オーストラリア英語は比較的聞き取りやすく、英語学習初心者にも適しています
                </li>
                <li style={{ marginBottom: '1rem' }}>
              ...
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                ビーチやアウトドアアクティビティが豊富で、サーフィン、ダイビング、ハイキングなどが楽しめます。自然と都市のバランスが良く、アクティブな生活を送りたい人に最適です。
              </p>
            </div>
          </section>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    ビーチや自然が好きな人には最高の環境。サーフィン、ダイビング、ハイキングなど、様々なアウトドアアクティビティが楽しめます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    英語圏で、比較的聞き取りやすいオーストラリア英語。語学学校も充実しており、英語力を伸ばすのに最適です。
                  </p>
                </div>
