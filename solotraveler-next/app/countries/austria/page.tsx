        ...
        <article style={{ lineHeight: 1.8, color: '#374151' }}>
          ...
          <section style={{ marginBottom: '5rem' }}>
            ...
            <div style={{ fontSize: '1.1rem', lineHeight: 1.8 }}>
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                オーストリアは、音楽と芸術、歴史的な街並みが魅力の国。ウィーンの音楽文化、ザルツブルクのモーツァルト、そして美しいアルプスの自然が特徴です。ハプスブルク帝国の歴史が息づく街並みと、高い文化水準を誇る国で、クラシック音楽やカフェ文化を楽しめます。
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1480413258216-ff003d179d65?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>音楽の都</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>ウィーンの音楽文化とオペラ</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1584088366082-67dd670d7ce4?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>モーツァルトの街</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>ザルツブルクの歴史的建造物</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1553537316-86354ef82879?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>アルプスの自然</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>美しい山々とウィンタースポーツ</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#78350f', lineHeight: 1.6 }}>
                    四季がはっきりしており、夏は温暖、冬は雪が降る。アルプス地方では冬にスキーが楽しめ、都市部では比較的過ごしやすい気候です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#1e3a8a', lineHeight: 1.6 }}>
                    ヨーロッパの中でも非常に安全な国として知られています。犯罪率が低く、日本人にとって安心して生活できる環境です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#14532d', lineHeight: 1.6 }}>
                    オーストリア人は礼儀正しく、文化的な教養が高い人が多いです。音楽や芸術を大切にし、伝統を重んじる文化があります。英語も比較的通じやすい環境です。
                  </p>
                </div>
              </div>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>ドイツ語学習：</strong>本場でドイツ語を学べる環境です
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>高い文化水準：</strong>音楽、芸術、歴史を通じて深い文化体験ができる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>ヨーロッパ旅行の拠点：</strong>他のヨーロッパ諸国へのアクセスが良好
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>自然体験：</strong>アルプスでのウィンタースポーツやアウトドアが楽しめる
                </li>
              </ul>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>標準ドイツ語：</strong>オーストリアのドイツ語は標準的で、学習に適している
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>英語も通じる：</strong>観光地や若い世代では英語も比較的通じやすい
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>文化的背景：</strong>音楽や芸術を通じて言語を学べる
                </li>
              </ul>
              ...
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                オーストリアは音楽の国として世界的に有名。ウィーン国立歌劇場やザルツブルク音楽祭など、世界最高峰の音楽文化に触れることができます。カフェ文化も盛んで、伝統的なウィーン・カフェでゆっくりとした時間を過ごせます。
              </p>
            </div>
          </section>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    クラシック音楽の本場で、ウィーン国立歌劇場やザルツブルク音楽祭を体験できます。モーツァルトやベートーヴェンの故郷で音楽文化を深く学べます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    アルプス山脈でのスキーやハイキング、自然公園でのアウトドアアクティビティが楽しめます。四季折々の美しい自然を満喫できます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    本場でドイツ語を学べる環境。オーストリアのドイツ語は標準的で、音楽や芸術を通じて文化的背景も学べます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    ハプスブルク帝国の歴史的建造物や美術館、伝統的なカフェ文化を体験できます。ヨーロッパの歴史と文化を深く学べます。
                  </p>
                </div>
              </div>
            </div>
          ...
          <section style={{ 
            ...
            <p style={{ 
              ...
              音楽と芸術、歴史的な街並みが魅力のオーストリアで、文化的なワーホリ体験を。
            </p>
            <button 
              onClick={() => router.push("/")}
              style={{
