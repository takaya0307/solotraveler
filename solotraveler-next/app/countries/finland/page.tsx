      ...
      <main style={{
        ...
        <div className="info-cards-grid" style={{
          ...
          <div className="info-card" style={{
            ...
            <div style={{ margin: 0 }}>
              <p style={{ margin: '0 0 0.3rem 0', fontSize: '1.8rem', fontWeight: 800 }}>なし</p>
          ...
          <div className="info-card" style={{
            ...
            <div style={{ margin: 0 }}>
              <p style={{ margin: '0 0 0.3rem 0', fontSize: '1.8rem', fontWeight: 800 }}>ビザ発給から1年</p>
        ...
        <article style={{ lineHeight: 1.8, color: '#374151' }}>
          ...
          <section style={{ marginBottom: '5rem' }}>
            ...
            <div style={{ fontSize: '1.1rem', lineHeight: 1.8 }}>
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                フィンランドは、美しい自然と洗練されたデザイン、そして高い教育水準が特徴の北欧の国です。首都ヘルシンキの美しい港町、豊富な森と湖、そして世界で最も幸福な国の一つとして知られる社会システムが魅力です。サウナ文化や北欧の伝統を体験しながら、四季折々の美しい風景を楽しめる魅力的な国です。
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1538332576228-eb5b4c4de6f5?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>港町の魅力</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>ヘルシンキの美しい海辺の景観</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1636452089599-56a0dc26b4f2?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>湖畔の美しさ</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>タンペレの二つの湖に挟まれた街</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1642747041760-96edbc00df69?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>トゥルク城の中世建築</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#78350f', lineHeight: 1.6 }}>
                    北欧の気候で、四季がはっきりしています。夏は涼しく過ごしやすく、冬は雪が降る寒い気候です。春と秋は美しい自然を楽しめる季節で、特に夏の白夜は神秘的です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#1e3a8a', lineHeight: 1.6 }}>
                    北欧の中でも特に治安が良く、日本人にとっては安心して生活できる環境です。福祉が充実し、社会的なセーフティネットも整っています。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#14532d', lineHeight: 1.6 }}>
                    フィンランド人は控えめで礼儀正しく、英語も広く通じます。個人の権利と自由を大切にし、環境問題への意識も高い国民性です。
                  </p>
                </div>
              </div>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>教育水準の高さ：</strong>世界トップレベルの教育システムを体験できる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>自然と都市の調和：</strong>美しい自然環境と洗練された都市生活の両方を楽しめる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>英語環境：</strong>若い世代を中心に英語が広く通じる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>北欧デザイン：</strong>世界的に有名な北欧デザインやアート文化を体験できる
                </li>
              </ul>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>サウナ文化：</strong>フィンランド発祥のサウナで、リラックスと健康を体験
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>北欧の伝統：</strong>フィンランドの伝統音楽や手工芸、そして食文化
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>自然との共生：</strong>森と湖の美しい自然環境でのアウトドアライフ
                </li>
              </ul>
              ...
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                フィンランドは「森と湖の国」として知られ、国土の約75%が森で覆われています。夏はハイキングやサイクリング、湖水浴、冬はスキーやスノーモービルなど、四季折々のアウトドアアクティビティを楽しめます。特に夏の白夜の時期は、24時間近く明るい時間が続き、自然を満喫できる特別な体験ができます。また、フィンランドの美しい湖は約18万個もあり、その美しさは世界的に有名です。
              </p>
            </div>
          </section>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    世界トップレベルの教育システムを体験したい方におすすめです。フィンランドの大学や研究機関で、質の高い教育を受けることができます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    北欧デザインやアート文化に興味がある方におすすめです。フィンランドの洗練されたデザインや、豊富な美術館で芸術的な刺激を受けることができます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    豊富な自然とアウトドアアクティビティが好きな方におすすめです。森と湖、美しい海岸線で、四季折々の自然を楽しめます。特に夏の白夜は神秘的です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    サウナ文化やリラックスした生活を送りたい方におすすめです。フィンランドの伝統的なサウナで、心身の健康とリラックスを体験できます。
                  </p>
                </div>
              </div>
            </div>
          ...
          <section style={{ 
            ...
            <p style={{ 
              ...
              自然とデザイン、教育水準の高さが魅力の北欧の国フィンランドで、特別なワーホリ体験を。
            </p>
            <button 
              onClick={() => router.push("/")}
              style={{
