    ...
    <>
      ...
      <main style={{
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '1.8rem', fontWeight: 700, margin: '0 0 1.5rem 0', color: '#1e293b' }}>ラトビアワーホリのおすすめポイント</h2>
        ...
        <div style={{
          ...
          <ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#7f1d1d', lineHeight: 1.6 }}>
            <li>ラトビア語の基本的な知識があると生活がスムーズです</li>
            <li>冬は寒く、日照時間が短くなります</li>
            <li>物価は日本と比較して安めですが、首都リガは高めです</li>
