...
export default function LithuaniaDetailPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', `リトアニアワーホリの費用、条件、おすすめエージェントを徹底比較。バルト海・文化・歴史の国でワーホリ体験。`);
    }
  }, []);
  ...
  const countryDescription = "リトアニアは、バルト海に面し、豊かな文化と深い歴史を持つ国です。ヴィリニュスをはじめとする美しい都市、そして美しい自然を満喫できます。";
  ...
  const workingHolidayReasons = [
    "リトアニア語学習環境：リトアニア語圏で、本格的なリトアニア語を学べる",
  ...
  const englishLearningEnvironment = [
    "リトアニア語学習：リトアニア語圏で、本格的なリトアニア語を学べる環境",
    "充実した語学学校：語学学校も充実しており、リトアニア語力を伸ばすのに最適",
    "多文化社会：様々な国の人々と交流でき、国際的な視点を身につけられる"
  ];
  
  const outdoorLifeDescription = "リトアニアには美しい海岸線、森、湖など、様々な自然環境があります。ハイキング、スキー、キャンプ、釣り、ビーチリゾートなど、四季を通じて様々なアウトドアアクティビティが楽しめます。";
  ...
  const recommendedFor = [
    ...
    {
      title: "リトアニア語学習",
      description: "リトアニア語を本格的に学びたい人に最適。リトアニア語圏で実践的な語学力を身につけられます。",
      color: "#1E40AF",
      borderColor: "#3B82F6",
      bgColor: "#EFF6FF",
      icon: "🗣️"
    ...
    {
      title: "文化体験",
      description: "伝統的なリトアニア文化を体験したい人に最適。",
      color: "#92400E",
      borderColor: "#F59E0B",
      bgColor: "#FEF3C7",
      icon: "🎭"
    ...
    {
      title: "歴史好き",
      description: "豊かな歴史を体験したい人に最適。歴史的建造物を満喫できます。",
      color: "#C2410C",
      borderColor: "#F97316",
      bgColor: "#FFF7ED",
      icon: "🏛️"
