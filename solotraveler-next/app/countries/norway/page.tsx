...
export default function NorwayDetailPage() {
  ...
  useEffect(() => {
    document.title = `ワーホリ ノルウェー比較｜費用・条件・おすすめエージェントを徹底比較`;
    
    // meta descriptionの更新
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', `ノルウェーワーホリの費用、条件、おすすめエージェントを徹底比較。フィヨルドとオーロラの国でワーホリ体験。`);
    }
  }, []);
        ...
        <article style={{ lineHeight: 1.8, color: '#374151' }}>
          ...
          <section style={{ marginBottom: '5rem' }}>
            ...
            <div style={{ fontSize: '1.1rem', lineHeight: 1.8 }}>
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                ノルウェーは、雄大なフィヨルドとオーロラ、高い生活水準が特徴の北欧の国。オスロの近代的な都市文化、ベルゲンの美しい港町、そしてトロンハイムの歴史的建造物が魅力です。自然と都市が調和した、世界で最も住みやすい国の一つとして知られています。
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1591082774583-88ac4b70c075?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>近代都市</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>オスロのオペラハウスと現代建築</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1645564386021-0db0dd3e2ad7?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>ベルゲンのカラフルな街並み</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1614417538522-19e59112c261?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>トロンハイムの大聖堂と学生文化</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#78350f', lineHeight: 1.6 }}>
                    四季がはっきりしており、夏は比較的温暖、冬は雪が降る。北部ではオーロラが見られ、フィヨルド沿いでは比較的過ごしやすい気候です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#14532d', lineHeight: 1.6 }}>
                    ノルウェー人は親切でフレンドリーな性格の人が多いです。自然を大切にし、環境保護に意識が高い文化があります。英語も広く通じる環境です。
                  </p>
                </div>
              </div>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>ノルウェー語学習：</strong>本場でノルウェー語を学べる環境です
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>雄大な自然：</strong>フィヨルドやオーロラなど、世界でも稀な自然体験ができる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>高い生活水準：</strong>世界で最も住みやすい国の一つとして知られる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>アウトドア文化：</strong>ハイキング、スキー、フィッシングなどが盛ん
                </li>
              </ul>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>実践的な学習：</strong>日常生活を通じて自然にノルウェー語が身につく
                </li>
                <li style={{ marginBottom: '1rem' }}>
              ...
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                ノルウェーは世界有数のフィヨルド観光地。美しいフィヨルド、オーロラ、そして豊富なアウトドアアクティビティが楽しめます。ハイキング、スキー、フィッシングなど、自然を満喫できる環境が整っています。
              </p>
            </div>
          </section>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    フィヨルドやオーロラ、ハイキング、スキーなど、世界でも稀な自然体験ができます。アウトドア文化が根づいた環境で、大自然を満喫できます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    北欧の文化や価値観、環境保護への意識の高さを体験できます。高い生活水準と福祉制度を備えた社会を学べます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    本場でノルウェー語を学べる環境。英語も広く通じるため、言語の壁が低く、北欧の文化と共に言語を学べます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    世界で最も住みやすい国の一つとして知られ、高い生活水準と福祉制度を体験できます。安全で安心な環境で生活できます。
                  </p>
                </div>
              </div>
            </div>
          ...
          <section style={{ 
            ...
            <p style={{ 
              ...
              雄大な自然と高い生活水準が特徴のノルウェーで、特別なワーホリ体験を。
            </p>
            <button 
              onClick={() => router.push("/")}
              style={{
