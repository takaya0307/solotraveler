...
export default function PortugalDetailPage() {
  ...
  useEffect(() => {
    document.title = `ワーホリ ポルトガル比較｜費用・条件・おすすめエージェントを徹底比較`;
    
    // meta descriptionの更新
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', `ポルトガルワーホリの費用、条件、おすすめエージェントを徹底比較。歴史・文化・自然の国でワーホリ体験。`);
    }
  }, []);
  ...
  const recommendedFor = [
    {
      title: "歴史好き",
      description: "大航海時代の歴史を体験したい人に最適。",
      color: "#166534",
      borderColor: "#22C55E",
      bgColor: "#F0FDF4",
      icon: "🏛️"
    ...
    {
      title: "ポルトガル語学習",
      description: "ポルトガル語を本格的に学びたい人に最適。ポルトガル語圏で実践的な語学力を身につけられます。",
      color: "#1E40AF",
      borderColor: "#3B82F6",
      bgColor: "#EFF6FF",
      icon: "🗣️"
    ...
    {
      title: "文化体験",
      description: "伝統的なポルトガル文化を体験したい人に最適。",
      color: "#C2410C",
      borderColor: "#F97316",
      bgColor: "#FFF7ED",
      icon: "🎭"
