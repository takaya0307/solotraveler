      ...
      <main style={{
        ...
        <div className="info-cards-grid" style={{
          ...
          <div className="info-card" style={{
            ...
            <div style={{ margin: 0 }}>
              <p style={{ margin: '0 0 0.3rem 0', fontSize: '1.8rem', fontWeight: 800 }}>最大2年間</p>
              <p style={{ margin: 0, fontSize: '1rem', fontWeight: 400, opacity: 0.8 }}>（最長滞在可能）</p>
            </div>
          </div>
        ...
        <article style={{ lineHeight: 1.8, color: '#374151' }}>
          ...
          <section style={{ marginBottom: '5rem' }}>
            ...
            <div style={{ fontSize: '1.1rem', lineHeight: 1.8 }}>
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                イギリスは、歴史と文化が息づくヨーロッパの中心地。ロンドンをはじめとする大都市から、美しい田園風景まで、多様な魅力を持つ国です。英語の本場で、世界最高峰の文化施設や歴史的建造物が数多く存在します。
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1512734099960-65a682cbfe2b?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>歴史と文化</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>世界遺産や歴史的建造物</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1595599014147-a419c147bdc0?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>アートと音楽</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>世界クラスの美術館やライブハウス</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1518005068251-37900150dfca?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>パブ文化</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>伝統的なパブでの交流</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#78350f', lineHeight: 1.6 }}>
                    四季がはっきりしており、夏は温暖、冬は寒い。雨が多いのが特徴で、傘が必需品です。地域によって気候が異なります。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#14532d', lineHeight: 1.6 }}>
                    イギリス人は礼儀正しく、ユーモアのセンスがある人が多いです。伝統を重んじる文化があり、紳士淑女の国として知られています。
                  </p>
                </div>
              </div>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>英語学習環境：</strong>英語の本場で、正統なイギリス英語を学べる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>豊富な文化施設：</strong>世界クラスの美術館や博物館が無料で楽しめる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>ヨーロッパ旅行の拠点：</strong>他のヨーロッパ各国へのアクセスが便利
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>長期滞在：</strong>最大2年間の滞在が可能で、じっくりと海外生活を楽しめる
                </li>
              </ul>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>正統なイギリス英語：</strong>英語の本場で、正統なイギリス英語を学べます
                </li>
                <li style={{ marginBottom: '1rem' }}>
              ...
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                大英博物館やナショナル・ギャラリーなど、世界クラスの文化施設が無料で楽しめます。ミュージカルや演劇、ライブミュージックなど、芸術文化も豊富です。
              </p>
            </div>
          </section>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    世界クラスの美術館や博物館が無料で楽しめる環境。ミュージカルや演劇など、芸術文化を満喫できます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    英語の本場で、正統なイギリス英語を学べる環境。語学学校も充実しており、英語力を伸ばすのに最適です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    ヨーロッパ各国へのアクセスが便利。フランス、ドイツ、イタリアなど、近隣諸国への旅行も気軽に楽しめます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    歴史と文化が息づく国。世界遺産や歴史的建造物が数多くあり、伝統的な文化を体験できます。
                  </p>
                </div>
              </div>
            </div>
          ...
          <section style={{ 
            ...
            <p style={{ 
              ...
              歴史と文化、英語の本場、ヨーロッパ旅行の拠点。イギリスはワーホリに最適な国です。
            </p>
            <button 
              onClick={() => router.push("/")}
              style={{
