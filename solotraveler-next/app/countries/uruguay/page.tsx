...
export default function UruguayDetailPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', `ウルグアイワーホリの費用、条件、おすすめエージェントを徹底比較。穏やかな気候とフレンドリーな人々が魅力の南米の国でワーホリ体験。`);
    }
  }, []);
        ...
        <article style={{ lineHeight: 1.8, color: '#374151' }}>
          ...
          <section style={{ marginBottom: '5rem' }}>
            ...
            <div style={{ fontSize: '1.1rem', lineHeight: 1.8 }}>
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                ウルグアイは、南米の東海岸に位置する小さな国で、穏やかな気候とフレンドリーな人々が魅力です。モンテビデオの美しいビーチ、プンタ・デル・エステの高級リゾート、そして豊富な牛肉とワインが特徴です。治安も良く、物価も比較的安いため、日本人にとっては安心して生活できる環境です。
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1590683696407-f75a80b4a61d?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>モンテビデオのラ・ランブラ沿い</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1653918488348-17d2a707012f?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>高級リゾート</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>プンタ・デル・エステの美しい海岸線</p>
                  </div>
                </div>
                
                <div style={{
                  background: 'url("https://images.unsplash.com/photo-1616959313137-186688889054?w=600&auto=format&fit=crop&q=60")',
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  height: '250px',
                  borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    <h4 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 600 }}>豊かな自然</h4>
                    <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>ウルグアイの美しい田園風景</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#78350f', lineHeight: 1.6 }}>
                    温暖な気候で、四季がはっきりしています。夏は暑く、冬は比較的温暖で過ごしやすいです。春と秋は快適な気候で、一年を通じて過ごしやすい環境です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#1e3a8a', lineHeight: 1.6 }}>
                    南米の中では比較的治安が良く、日本人にとっては安心して生活できる環境です。特に観光地や昼間は安全ですが、夜間は注意が必要です。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#14532d', lineHeight: 1.6 }}>
                    ウルグアイ人は温かく親切で、家族や友人を大切にする文化があります。スペイン語が主な言語で、観光客にもフレンドリーに接してくれます。
                  </p>
                </div>
              </div>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>美しいビーチ：</strong>モンテビデオやプンタ・デル・エステの美しい海岸線
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>豊富なグルメ：</strong>世界有数の牛肉とワインを楽しめる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>穏やかな生活：</strong>南米の中でも落ち着いた環境で生活できる
                </li>
              </ul>
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '1rem' }}>
                  <strong>ウルグアイスペイン語：</strong>ウルグアイ独特のスペイン語アクセントや表現を学べる
                </li>
                <li style={{ marginBottom: '1rem' }}>
                  <strong>南米文化：</strong>南米の文化や価値観を学べる
                </li>
              </ul>
              ...
              <p style={{ marginBottom: '2.5rem', color: '#4b5563', fontSize: '1.15rem' }}>
                ウルグアイは世界有数の牛肉産地として知られ、特にアサード（バーベキュー）が有名です。また、タンニャ（マテ茶）やワインも豊富で、シーフードやエンパナーダなど、豊富で美味しい料理が楽しめます。モンテビデオには高級レストランから地元の味まで、様々なグルメスポットがあります。
              </p>
            </div>
          </section>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    モンテビデオの美しいビーチやプンタ・デル・エステの高級リゾートで、ビーチライフを満喫できます。サーフィンやビーチアクティビティも楽しめます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    世界有数の牛肉とワインを楽しめます。アサード（バーベキュー）やタンニャ（マテ茶）、シーフードなど、豊富なグルメ体験ができます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    本場でスペイン語を学べる環境。ウルグアイ独特のアクセントや表現を学びながら、南米の文化と共に言語を学べます。
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    南米の中でも落ち着いた環境で、穏やかな生活を送りたい方におすすめです。物価も比較的安く、治安も良好です。
                  </p>
                </div>
              </div>
            </div>
          ...
          <section style={{ 
            ...
            <p style={{ 
              ...
              穏やかな気候とフレンドリーな人々が魅力のウルグアイで、特別なワーホリ体験を。
            </p>
            <button 
              onClick={() => router.push("/")}
              style={{
